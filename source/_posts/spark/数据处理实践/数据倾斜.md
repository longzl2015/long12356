...
![uncompressedfiles](数据倾斜/uncompressedfiles.png)

之后将8.5GB大小的文件使用gzip压缩，压缩后大小仅为25.3MB。
![compressedfiles](数据倾斜/compressedfiles.png)
...
![splitable_unskewed](数据倾斜/splitable_unskewed.png)
...
![compressedfileskew](数据倾斜/compressedfileskew.png)
...
![unsplitable_skew](数据倾斜/unsplitable_skew.png)
...
![changeparallelism](数据倾斜/changeparallelism.png)
...
![differentkeyskew12](数据倾斜/differentkeyskew12.png)
...
![differentkeyskew48](数据倾斜/differentkeyskew48.png)
...
![differentkeyskew11](数据倾斜/differentkeyskew11.png)
...
![customizedpartition](数据倾斜/customizedpartition.png)
...
![reducejoindag](数据倾斜/reducejoindag.png)

从下图可见，Join Stage各Task处理的数据倾斜严重，处理数据量最大的Task耗时7.1分钟，远高于其它无数据倾斜的Task约2秒的耗时。
![reducejoinlaststage](数据倾斜/reducejoinlaststage.png)
...
![reducejoincachedag](数据倾斜/reducejoincachedag.png)

并且数据倾斜仍然存在。如下图所示，最慢的Task耗时为7.1分钟，远高于其它Task的约2秒。
![reducejoincachelaststage](数据倾斜/reducejoincachelaststage.png)
...
![mapjoindag](数据倾斜/mapjoindag.png)

并且从下图可见，各Task耗时相当，无明显数据倾斜现象。并且总耗时为1.5分钟，远低于Reduce侧Join的7.3分钟。
![mapjoinlaststage](数据倾斜/mapjoinlaststage.png)
...
![randomprefix](数据倾斜/randomprefix.png)
...
![fewskewkeyjoinallstage](数据倾斜/fewskewkeyjoinallstage.png)
...
![fewskewkeyjoinlaststage](数据倾斜/fewskewkeyjoinlaststage.png)
...
![fewskewkeyrandomjoinallstage](数据倾斜/fewskewkeyrandomjoinallstage.png)
...
![fewskewkeyjoinrandomlaststage](数据倾斜/fewskewkeyjoinrandomlaststage.png)
...
![randomprefixandenlargesmalltable](数据倾斜/randomprefixandenlargesmalltable.png)
