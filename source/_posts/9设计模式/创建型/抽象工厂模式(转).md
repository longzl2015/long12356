...
**抽象工厂模式与工厂方法模式最大的区别**在于，工厂方法模式针对的是一个产品等级结构，而抽象工厂模式则需要面对多个产品等级结构，一个工厂等级结构可以负责多个不同产品等级结构中的产品对象的创建 
...
package "Factory"{
abstract class AbsLogFactory
ConcreteFactory1 -up..|> AbsLogFactory
ConcreteFactory2 -up..|> AbsLogFactory
}

package "ProductA"{
abstract class AbsProductA
abstract class AbsProductB
ProductA1 -up..|> AbsProductA
ProductA2 -up..|> AbsProductA
ProductB1 -up..|> AbsProductB
ProductB2 -up..|> AbsProductB
}
...
## 来源 
[抽象工厂](https://design-patterns.readthedocs.io/zh_CN/latest/creational_patterns/abstract_factory.html)